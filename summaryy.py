...
df=pd.read_csv(r"C:\Users\PRAMILA\Downloads\Reviews.csv\Reviews.csv",nrows=100000)
#drop the duplicate and na values from the records
df.drop_duplicates(subset=['Text'],inplace=True)
df.dropna(axis=0,inplace=True)
input_data = df.loc[:,'Text']
target = df.loc[:,'Summary']
...
input_words=[]
target_words=[]
contractions= pickle.load(open(r"C:\Users\PRAMILA\Downloads\text-summarization-ml-project (1)\contractions.pkl","rb"))['contractions']
...
for in_txt,tr_txt in zip(input_data,target):
